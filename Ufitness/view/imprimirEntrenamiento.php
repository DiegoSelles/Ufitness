...
<head>
    ...
    <title> Imprimir Entrenamiento - Ufitness</title>
    ...
    <div id="wrapper">
      ...
      <div id="contenido" class="container-fluid">
        <div class="titulo_seccion">
          ...
          <strong>Imprimir entrenamiento</strong>
        </div>
        <div >
          <form action="../controller/controlador.php?controlador=controlador_Entrenamiento&amp;accion=imprimirEntrenamiento" method="post" class="formulario">
              ...
              <div class="form_submit">
                <input id="submit" class="btn btn-primary" type="submit" value="Imprimir entrenamiento">
              </div>
