    ...
    <div id="wrapper">
          ...
          <div id="contenido" class="container-fluid">
            ...
            <div class="body_pagina">
				<?php
				$entrenamientos = $econtroller->listarEntrenamientosCompletadosDeportista("principiante",$_SESSION["Dni"]);
				 ?>
				<nav id = "desplegable1">
					<ul>
			...
			<?php
			$entrenamientos = $econtroller->listarEntrenamientosCompletadosDeportista("intermedio",$_SESSION["Dni"]);
			?>
            <nav id = "desplegable2">
              <ul>
			...
			<?php
			$entrenamientos = $econtroller->listarEntrenamientosCompletadosDeportista("avanzado",$_SESSION["Dni"]);
