...
START TRANSACTION;
USE `Ufitness`;
INSERT INTO `Ufitness`.`Actividad` (`idActividad`, `Usuario_Dni`, `numPlazas`, `horario`, `lugar`, `tipoAct`) VALUES (1, '44444444B', 20, '2016-11-20 19:00:00', 'pabellon', 'individual');
INSERT INTO `Ufitness`.`Actividad` (`idActividad`, `Usuario_Dni`, `numPlazas`, `horario`, `lugar`, `tipoAct`) VALUES (2, '44444444B', 30, '2016-11-21 21:00:00', 'pabellon', 'grupo');
...
START TRANSACTION;
USE `Ufitness`;
INSERT INTO `Ufitness`.`Notificacion` (`idNotificacion`, `Usuario_Dni`, `Deportista_Usuario_Dni`, `descripcion`) VALUES (1, '11223344F', '66666666C', 'Nueva actividad');
...
START TRANSACTION;
USE `Ufitness`;
INSERT INTO `Ufitness`.`Entrenamiento` (`idEntrenamiento`, `Deportista_DNI`, `duracion`) VALUES (1, '66666666C', 30);
INSERT INTO `Ufitness`.`Entrenamiento` (`idEntrenamiento`, `Deportista_DNI`, `duracion`) VALUES (2, '77777777D', 15);
...
START TRANSACTION;
USE `Ufitness`;
INSERT INTO `Ufitness`.`Ejercicio` (`idEjercicio`, `Usuario_Dni`, `tipoEjer`, `maquina`, `grupoMuscular`, `descripcion`, `imagen`, `video`) VALUES (1, '44444444B', 'muscular', 'press banca', 'pectorales', 'levantamiento de pesas en una determinada posicion', NULL, NULL);
INSERT INTO `Ufitness`.`Ejercicio` (`idEjercicio`, `Usuario_Dni`, `tipoEjer`, `maquina`, `grupoMuscular`, `descripcion`, `imagen`, `video`) VALUES (2, '44444444B', 'cardio', 'bici estatica', NULL, 'Pedaleo de forma ciclica', NULL, NULL);
INSERT INTO `Ufitness`.`Ejercicio` (`idEjercicio`, `Usuario_Dni`, `tipoEjer`, `maquina`, `grupoMuscular`, `descripcion`, `imagen`, `video`) VALUES (3, '44444444B', 'estiramiento', 'abdominal', NULL, 'Tumbarse boca abajo levantando el torso', NULL, NULL);
