...
START TRANSACTION;
USE `Ufitness`;
INSERT INTO `Ufitness`.`Entrenamiento` (`idEntrenamiento`, `Deportista_DNI`, `duracion`, `nombre`) VALUES (1, '66666666C', 30, 'press banca');
INSERT INTO `Ufitness`.`Entrenamiento` (`idEntrenamiento`, `Deportista_DNI`, `duracion`, `nombre`) VALUES (2, '77777777D', 15, 'bicicleta');
