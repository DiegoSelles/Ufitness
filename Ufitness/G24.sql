...
START TRANSACTION;
USE `G24`;
INSERT INTO `G24`.`Entrenamiento` (`idEntrenamiento`, `Deportista_DNI`, `duracion`, `nombre`, `nivel`) VALUES (1, '66666666C', 30, 'press banca', 'principiante');
INSERT INTO `G24`.`Entrenamiento` (`idEntrenamiento`, `Deportista_DNI`, `duracion`, `nombre`, `nivel`) VALUES (2, '77777777D', 15, 'bicicleta', 'intermedio');
