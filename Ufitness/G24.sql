...
-- -----------------------------------------------------
-- Table `Ufitness`.`Entrenamiento_has_Deportista`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Ufitness`.`Entrenamiento_has_Deportista` (
  `Entrenamiento_idEntrenamiento` INT NOT NULL,
...
START TRANSACTION;
USE `Ufitness`;
INSERT INTO `Ufitness`.`Usuario` (`Dni`, `Usuario_Dni`, `rol`, `Nombre`, `email`, `password`, `fecha_nacimiento`) VALUES ('11223344F', NULL, 'administrador', 'Samuel', 'samuel@gmail.com', 'root', '1994-11-2');
INSERT INTO `Ufitness`.`Usuario` (`Dni`, `Usuario_Dni`, `rol`, `Nombre`, `email`, `password`, `fecha_nacimiento`) VALUES ('44444444B', NULL, 'entrenador', 'Emily', 'emily@gmail.com', 'root', '1993-10-1');
INSERT INTO `Ufitness`.`Usuario` (`Dni`, `Usuario_Dni`, `rol`, `Nombre`, `email`, `password`, `fecha_nacimiento`) VALUES ('66666666C', NULL, 'deportista', 'Diego', 'diego@gmail.com', 'root', '1995-5-15');
INSERT INTO `Ufitness`.`Usuario` (`Dni`, `Usuario_Dni`, `rol`, `Nombre`, `email`, `password`, `fecha_nacimiento`) VALUES ('77777777D', NULL, 'deportista', 'Ruben', 'ruben@gmail.com', 'root', '1994-6-22');
INSERT INTO `Ufitness`.`Usuario` (`Dni`, `Usuario_Dni`, `rol`, `Nombre`, `email`, `password`, `fecha_nacimiento`) VALUES ('88888888E', NULL, 'deportista', 'Ismael', 'ismale@gmail.com', 'root', '1995-1-29');
INSERT INTO `Ufitness`.`Usuario` (`Dni`, `Usuario_Dni`, `rol`, `Nombre`, `email`, `password`, `fecha_nacimiento`) VALUES ('99999999F', NULL, 'deportista', 'Ramon', 'ramon@gmail.com', 'root', '1992-2-1');
...
START TRANSACTION;
USE `Ufitness`;
INSERT INTO `Ufitness`.`Entrenamiento` (`idEntrenamiento`, `duracion`, `nombre`, `nivel`) VALUES (1, 30, 'press banca', 'principiante');
INSERT INTO `Ufitness`.`Entrenamiento` (`idEntrenamiento`, `duracion`, `nombre`, `nivel`) VALUES (2, 15, 'bicicleta', 'intermedio');
...
START TRANSACTION;
USE `Ufitness`;
INSERT INTO `Ufitness`.`Reserva` (`idReserva`, `Deportista_Usuario_Dni`, `Actividad_idActividad`, `fecha`, `plazas_ocupadas`) VALUES (1, '66666666C', 1, '2016-11-20', 19);
INSERT INTO `Ufitness`.`Reserva` (`idReserva`, `Deportista_Usuario_Dni`, `Actividad_idActividad`, `fecha`, `plazas_ocupadas`) VALUES (2, '77777777D', 2, '2016-11-21', 29);
...
START TRANSACTION;
USE `Ufitness`;
INSERT INTO `Ufitness`.`Ejercicio` (`idEjercicio`, `Usuario_Dni`, `nombre`, `tipoEjer`, `maquina`, `grupoMuscular`, `descripcion`, `imagen`, `video`) VALUES (1, '11223344F', 'Sentadillas', 'Muscular', 'Banco Smith', 'Piernas', 'Flexionar cadera y rodillas hasta formas un angulo', NULL, NULL);
INSERT INTO `Ufitness`.`Ejercicio` (`idEjercicio`, `Usuario_Dni`, `nombre`, `tipoEjer`, `maquina`, `grupoMuscular`, `descripcion`, `imagen`, `video`) VALUES (2, '11223344F', 'Curl de biceps', 'Muscular', 'Banco Scott', 'Brazos', 'Coger la barra a una separacion media entre manos', NULL, NULL);
INSERT INTO `Ufitness`.`Ejercicio` (`idEjercicio`, `Usuario_Dni`, `nombre`, `tipoEjer`, `maquina`, `grupoMuscular`, `descripcion`, `imagen`, `video`) VALUES (3, '11223344F', 'Dominadas', 'Muscular', 'Barra de dominadas', 'Esplada', 'Elevarse con los brazos hasta pasar la barbilla', NULL, NULL);
