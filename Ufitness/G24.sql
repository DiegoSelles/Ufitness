...
START TRANSACTION;
USE `G24`;
INSERT INTO `G24`.`Ejercicio` (`idEjercicio`, `Usuario_Dni`, `nombre`, `tipoEjer`, `maquina`, `grupoMuscular`, `descripcion`, `imagen`, `video`) VALUES (1, '11223344F', 'Sentadillas', 'Muscular', 'Banco Smith', 'Piernas', 'Flexionar cadera y rodillas hasta formas un angulo', NULL, NULL);
INSERT INTO `G24`.`Ejercicio` (`idEjercicio`, `Usuario_Dni`, `nombre`, `tipoEjer`, `maquina`, `grupoMuscular`, `descripcion`, `imagen`, `video`) VALUES (2, '11223344F', 'Curl de biceps', 'Muscular', 'Banco Scott', 'Brazos', 'Coger la barra a una separacion media entre manos', NULL, NULL);
INSERT INTO `G24`.`Ejercicio` (`idEjercicio`, `Usuario_Dni`, `nombre`, `tipoEjer`, `maquina`, `grupoMuscular`, `descripcion`, `imagen`, `video`) VALUES (3, '11223344F', 'Dominadas', 'Muscular', 'Barra de dominadas', 'Esplada', 'Elevarse con los brazos hasta pasar la barbilla', NULL, NULL);
