...
START TRANSACTION;
USE `G24`;
INSERT INTO `G24`.`Notificacion` (`idNotificacion`, `Usuario_Dni`, `Deportista_Usuario_Dni`, `titulo`, `descripcion`, `visto`) VALUES (1, '11223344F', '66666666C', 'Actividad spinning', 'Nueva actividad', DEFAULT);
